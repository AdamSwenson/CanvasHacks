...
if __name__ == '__main__':
    start_unit = sys.argv[0] if sys.argv[0] is not None else START_UNIT
    stop_unit = sys.argv[1] if sys.argv[1] is not None else STOP_UNIT
    minutes_rest = sys.argv[2] if sys.argv[2] is not None else MINUTES_REST

    main(start_unit, stop_unit, minutes_rest)
