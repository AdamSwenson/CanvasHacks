...
class SendInitialWorkToReviewer(IStep):
    ...
    def run(self, **kwargs):
        ...
        """
        try:
            # In case any messages failed to send previously,
            # send them before doing anything else.
            self._clear_queue()
    ...
    def _clear_queue(self):
        """
        Makes sure that any queued messages are sent.
        This only needs to be run on the first step since it will
