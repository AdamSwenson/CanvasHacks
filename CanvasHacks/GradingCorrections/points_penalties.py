...
class IPenalizerPoints(ABC):
    ...
    def analyze( self,  *args, **kwargs ):
        ...
        Returns a negative float representing the points that the total score
        should be adjusted down
        :param record: The record to have penalties added to
        :return: PointsRecord
        """
...
class NoLatePenaltyPoints( IPenalizerPoints ):
    """
...
class HalfLatePoints( IPenalizerPoints, TimeHandlerMixin ):
...
class QuarterLatePoints( IPenalizerPoints, TimeHandlerMixin ):
    """
