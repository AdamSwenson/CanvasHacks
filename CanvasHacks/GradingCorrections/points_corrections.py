...
from CanvasHacks.GradingCorrections.base import IGradeCorrection, IGradeCorrectionPoints
...
class ForfeitedPointsCorrectorPoints(IGradeCorrectionPoints):
    """
...
class NonSubmittingStudentCorrectorPoints(ObjectHandlerMixin):
    """
