...
from CanvasHacks.Repositories.status import SentFeedbackStatusRepository, SentInvitationStatusRepository
...
class TestSentInvitationStatusRepository( TestingBase ):
    def setUp(self):
        ...
        self.obj = SentInvitationStatusRepository(self.dao, self.activity)
    ...
    #     result = self.obj.reviewers_with_notified_authors
    #
